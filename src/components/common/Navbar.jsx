...
export default function Navbar() {
  return (
    <A.CompContainer>
      <NavButtonComp iconSvg={refrigeratorSvg} activeIconSvg={refrigeratorActiveSvg} navUrl="refrigerator" navText="냉장고" />
      <NavButtonComp iconSvg={recipeSvg} activeIconSvg={recipeActiveSvg} navUrl="recipe" navText="레시피" />
      <NavButtonComp iconSvg={communitySvg} activeIconSvg={communityActiveSvg} navUrl="community" navText="이웃의 장" />
      <NavButtonComp iconSvg={mypageSvg} activeIconSvg={mypageActiveSvg} navUrl="my-page" navText="내 정보" />
    </A.CompContainer>
  );
}
